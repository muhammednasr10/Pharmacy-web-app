...
export function useAppBindingsSlice({
  ...
  const { pageRouterProps, appModalsProps, appShellProps } = useAppBindings({
    ...
    pendingPharmacySignupRequests: tenant.pendingPharmacySignupRequests,
    ...
    dashboardSalesTotal: metrics.todaySalesTotal,
    dashboardInvoicesCount: metrics.todayInvoicesCount,
    ...
    handleApprovePharmacySignupRequest: tenant.handleApprovePharmacySignupRequest,
    handleRejectPharmacySignupRequest: tenant.handleRejectPharmacySignupRequest,
