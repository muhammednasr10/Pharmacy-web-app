...
type TransferBarcodeInputProps = {
  medicines: Medicine[];
  isArabic: boolean;
  onScan: (medicine: Medicine) => void;
  disabled?: boolean;
};

export default function TransferBarcodeInput({
  medicines,
  isArabic,
  onScan,
  disabled = false,
  ...
  return (
    <div className="posBarcodeBlock branchTransferBarcodeBlock">
      <label className="posBarcodeLabel" htmlFor="transfer-barcode-input">
        {isArabic ? "مسح الباركود لإضافة صنف" : "Scan barcode to add item"}
      </label>
